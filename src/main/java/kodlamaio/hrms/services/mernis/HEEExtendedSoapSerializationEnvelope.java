...
public class HEEExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(HEEDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new HEEStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static HEEDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static HEEDateTimeConverter dateTimeConverter = new HEEStandardDateTimeConverter();

    public HEEExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public HEEExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new HEEMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=HEEHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,HEEExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=HEEHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
