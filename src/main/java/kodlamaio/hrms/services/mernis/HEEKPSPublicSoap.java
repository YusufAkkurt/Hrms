...
public class HEEKPSPublicSoap
{
    ...
    public HEEKPSPublicSoap(){}

    public HEEKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HEEKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HEEExtendedSoapSerializationEnvelope envelope= new HEEExtendedSoapSerializationEnvelope(HEEExtendedSoapSerializationEnvelope.VER11);
